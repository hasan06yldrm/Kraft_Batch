...
public class C03_ArrayMethods {
    public static void main(String[] args) {
        //         split()  söylediğimiz yerleri kesiyor ve ayrı ayrı yazdırıyor
        ...
        //sort() düzenliyor küçükten büyüğe ya da a dan z ye gibi
//        Arrays.sort(strArr);
//        System.out.println("Sorted strArr = " + Arrays.toString(strArr));
        ...
        System.out.println("----------------------------");
        //toCharArray()  char olarak karakterleri ayırıyor
        ...
        //        copyOfRange()  String substring gibi
        ...
        System.out.println("----------------------------");
        // fill() dediğimiz yerden itibaren istediğimiz şekilde değiştirir
