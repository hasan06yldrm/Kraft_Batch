...
public class C01_Collections {
    ...
    /*Colection nesneleri objeleri bir arada tutan yapılar
      Karşılaşılan istenilen durumlara gore kullanilan collection yapilari farklilik gosterir
      ...
      Interfacelerden obje olusturamadigimiz için child classlarin constructorlari kullanilarak objeler olusturuyoruz
     *
     *
     *
     */
        ...
        arr[2]=3;
        arr[3]=4;
       // arr[4]=5;//ArrayIndexOutOfBoundsException hatası alırız 4 dedik 5 yaptigimiz icin

       // List<String> coll1=new List<String>(); //Interface Obje olusturamiyoruz
        List<String> coll2=new ArrayList<>();
        List<String> coll3=new LinkedList<>();
