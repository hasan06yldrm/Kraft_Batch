...
public class C06_ArraysReview {
    public static void main(String[] args) {
        ...
        int[] numbers = {5, 10, 15, 20, 25, 30};  // array literal used if we know all the elements if the array  ne kadar deger olacagı biliniyorsa
                       //0   1   2   3   4   5
//    int[] num;
//    num={1,2,3,4,5};
        ...
        System.out.println(numbers);//Sadece referans gelir yazmaz yazmak için toString gerekir
        ...
        System.out.println(Arrays.toString(arr2D));//Referans yazar deepToString ile yazar
