...
public class _05_RelationalOperators {
    public static void main(String[] args) {
        ...
        int x=100;
        int y=200;
        boolean isEqual=x==y;//x y ye eşit mi
        System.out.println("isEqual = " + isEqual);

        boolean result7="ihsan"=="ahmet"; //Stringlerde == kullanılmaz
        ...
        boolean result10=100 !=200; //!= eşit değil
        System.out.println("result10 = " + result10);

        boolean result11=200!=200;
        System.out.println("result11 = " + result11);

        boolean result12="Java"!="Zor";//Stringlerde == ile yapılmaz
